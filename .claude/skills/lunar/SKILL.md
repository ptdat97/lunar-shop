...
<!--
  NGUỒN: vendor/lunarphp/core/resources/boost/skills/lunar/SKILL.md (Lunar 1.5.0).
  Đây là bản sao nguyên văn do Lunar phát hành, KHÔNG sửa tay — mỗi lần nâng
  Lunar hãy copy lại từ vendor để nhận bản cập nhật:

      cp vendor/lunarphp/core/resources/boost/skills/lunar/SKILL.md \
         .claude/skills/lunar/SKILL.md

  Bối cảnh riêng của dự án này (module nwidart, ProductSku thay ProductVariant,
  storefront Blade SSR) nằm ở docs/, không thêm vào đây.
-->
