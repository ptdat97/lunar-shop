                    ...
                    <tbody>
                        @foreach($order->productLines as $line)
                            <tr>
                                ...
                                <td class="text-end">{{ $line->format('sub_total') }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
