...
return [
    ...
    'editor' => [
        ...
        'nav' => 'Chi tiết',
        'gallery' => 'Hình ảnh',
        'gallery_hint' => 'Kéo thả để tải lên và sắp xếp. Ảnh đầu tiên là ảnh chính của sản phẩm.',
        'suggest_sku' => 'Gợi ý SKU từ tên sản phẩm',
        'simple' => 'Giá & Tồn kho',
        'simple_hint' => 'Sản phẩm chưa bật biến thể — quản lý SKU, giá và tồn kho tại đây. Khi bật size/màu ở khối Biến thể bên dưới, các giá trị này chuyển sang bảng biến thể.',
        'status' => 'Trạng thái',
        'organisation' => 'Phân loại',
        'collections' => 'Danh mục',
        'related' => 'Sản phẩm liên quan',
        'related_hint' => 'Hiển thị ở khối gợi ý trên trang sản phẩm (bán chéo).',
        'url' => 'Đường dẫn (URL)',
        'url_hint' => 'Mỗi ngôn ngữ một đường dẫn. Bỏ trống sẽ tự tạo từ tên sản phẩm.',
        'logistics' => 'Kho & Vận chuyển',
        'pricing' => 'Giá & Thuế',
        'availability' => 'Phạm vi bán',
        'identifiers' => 'Mã định danh',
        'identifiers_hint' => 'Mã sản phẩm toàn cầu (GTIN/UPC/EAN), mã nhà sản xuất (MPN) — dùng cho đồng bộ kênh bán và tra cứu.',
        'inventory' => 'Tồn kho',
        'shipping' => 'Vận chuyển',
    ],
    ...
    'variants' => [
        ...
        'options_title' => 'Biến thể',
        'options_hint' => 'Bật/tắt size và màu cho sản phẩm này. Thay đổi chỉ được áp dụng sau khi bấm Lưu biến thể.',
        'size_label' => 'Kích cỡ',
        'color_label' => 'Màu sắc',
        'color_hint' => 'Chọn mã màu hiển thị hoặc tải ảnh swatch cho từng màu (ảnh sẽ được ưu tiên).',
        'add' => 'Thêm',
        'add_size_placeholder' => 'VD: XXL',
        'add_color_placeholder' => 'VD: Đỏ đô',
        'add_value_placeholder' => 'Thêm giá trị',
        'add_option' => 'Thêm phân loại',
        'add_option_placeholder' => 'VD: Chất liệu',
        'option_name_placeholder' => 'Tên phân loại',
        'remove_option' => 'Xóa phân loại',
        'pick_color' => 'Chọn mã màu',
        'swatch_image' => 'Chèn ảnh',
        'change_image' => 'Đổi ảnh',
        'remove_image' => 'Xóa ảnh',
        'pick_from_library' => 'Chọn từ thư viện',
        'library_image' => 'Ảnh trong thư viện media',
        'enabled' => 'Sử dụng cho sản phẩm này',
        'variants_title' => 'Danh sách biến thể',
        'variant' => 'Biến thể',
        ...
        'delete' => 'Xóa',
        'save' => 'Lưu biến thể',
        'enable_multiple' => 'Bật nhiều biến thể',
        'single_product_hint' => 'Sản phẩm đơn — quản lý SKU, giá và tồn kho ở tab Chi tiết.',
        'pick_image' => 'Chọn ảnh',
        'primary_image' => 'Ảnh chính',
        'bulk_value_placeholder' => 'Giá trị',
        'bulk_apply_all' => 'Cài đặt hàng loạt',
        'sku_required' => 'Vui lòng nhập SKU cho tất cả biến thể trước khi lưu.',
        'sku_duplicate' => 'SKU ":sku" bị trùng ở nhiều biến thể. Mỗi biến thể cần một SKU riêng.',
        'price_invalid' => 'Giá biến thể phải là số không âm.',
        'status_invalid' => 'Trạng thái biến thể không hợp lệ.',
        'empty' => 'Chọn ít nhất một size hoặc màu để tạo biến thể.',
    ],
