...
return [
    ...
    'notification_settings' => [
        ...
        'mail_desc' => 'Máy chủ gửi email xác nhận đơn hàng và cập nhật trạng thái.',
        'mail_override' => 'Cấu hình SMTP tại đây',
        'mail_override_help' => 'Tắt thì hệ thống dùng cấu hình trong .env của máy chủ. Bật để trỏ cửa hàng sang máy chủ mail của bạn mà không cần sửa file.',
        ...
        'sms_section' => 'SMS',
        'sms_desc' => 'Nhắn tin cho khách khi đơn hàng đổi trạng thái. SMS tới được cả khách mua không cần tài khoản — nhóm này không nhận được thông báo trong app.',
        'sms_enabled' => 'Gửi SMS cho khách hàng',
        'sms_enabled_help' => 'Mỗi tin nhắn đều bị nhà mạng tính phí, hãy cân nhắc khi chọn các sự kiện bên dưới.',
        'sms_events' => 'Gửi SMS khi đơn chuyển sang',
        'sms_events_help' => 'Trạng thái không tích chọn sẽ không gửi tin nào.',
        ...
        'sms_sender_help' => 'Brandname đã đăng ký với nhà cung cấp, nếu họ yêu cầu.',
        'sms_fields_section' => 'Tên tham số của nhà cung cấp',
        'sms_fields_desc' => 'Chỉ sửa nếu nhà cung cấp của bạn đặt tên tham số khác với mặc định.',
        ...
        'secret_keep_help' => 'Để trống nếu muốn giữ giá trị đã lưu.',
        'test_mail' => 'Gửi email thử',
        'test_sms' => 'Gửi SMS thử',
        'testing' => 'Đang gửi…',
        'test_phone' => 'Số điện thoại thử',
        'test_phone_help' => 'Chỉ dùng cho nút gửi thử, không được lưu lại.',
        'test_sent' => 'Đã gửi tin nhắn thử tới :recipient.',
        'test_failed' => 'Không gửi được tin nhắn thử.',
        'test_no_recipient' => 'Tài khoản quản trị của bạn chưa có địa chỉ email.',
        'test_no_phone' => 'Hãy nhập số điện thoại để gửi thử.',
        'test_sms_unconfigured' => 'Hãy lưu địa chỉ API và API key trước đã.',
        'test_sms_failed_help' => 'Nhà cung cấp từ chối tin nhắn hoặc không kết nối được. Xem log ứng dụng để biết phản hồi chi tiết.',
        'test_saved_note' => 'Chức năng gửi thử dùng cấu hình đã lưu — hãy lưu thay đổi trước.',
    ],
    ...
    'inventory' => [
        ...
        'stock' => 'Tồn kho',
        'on_hand' => 'Tồn thực',
        'on_hand_tip' => 'Số hàng đang có trong kho — kể cả hàng đã bán nhưng chưa giao',
        'committed' => 'Đã giữ',
        'committed_tip' => 'Đã bán nhưng chưa xuất kho — vẫn nằm trong kho, không bán tiếp được',
        'sellable' => 'Bán được',
        'sellable_tip' => 'Tồn thực trừ hàng đã giữ — số thực sự còn bán được',
        'stale_commitment' => 'Đơn đã thanh toán quá :days ngày chưa giao — hàng đang bị giữ',
        'status' => 'Trạng thái',
        'backorder' => 'Đặt trước',
        'mode' => 'Chế độ',
        'waiting' => 'Đang chờ',
    ...
    'variants' => [
        'title' => 'Biến thể',
        'definition_section' => 'Tùy chọn biến thể',
        'definition_desc' => 'Định nghĩa từng trục (vd Màu, Size) và các giá trị. Không dùng danh mục chung — chỉ thuộc sản phẩm này.',
        'axis_name' => 'Tên tùy chọn',
        'display_type' => 'Hiển thị dạng',
        'display_text' => 'Nút chữ',
        'display_color' => 'Ô chọn màu',
        'display_image' => 'Ô chọn ảnh',
        'value_label' => 'Giá trị',
        'value_color' => 'Màu',
        'value_image' => 'Ảnh ô chọn',
        'add_value' => 'Thêm giá trị',
        'add_axis' => 'Thêm tùy chọn',
        'new_axis' => 'Tùy chọn mới',
        'generate' => 'Sinh tổ hợp',
        'skus_section' => 'Danh sách SKU',
        'skus_desc' => 'Mỗi dòng là một tổ hợp. Đặt mã, giá, tồn kho và trạng thái cho từng SKU.',
        'combination' => 'Tổ hợp',
        'sku_code' => 'Mã SKU',
        'price' => 'Giá (đơn vị nhỏ)',
        ...
        'none_generated' => 'Hãy thêm ít nhất một tùy chọn có giá trị trước.',
        'save_failed' => 'Không lưu được biến thể',
    ],
    ...
    'options' => [
        ...
        'display_type_hint' => 'Cách tùy chọn này hiển thị ở storefront: chữ, ô chọn màu (kèm ảnh swatch tùy chọn) hoặc ảnh.',
        'display_types' => [
            'text' => 'Chữ',
            'color' => 'Chọn màu',
            'image' => 'Ảnh',
    ...
    'create' => [
        ...
        'label' => 'Thêm sản phẩm',
        'description' => 'Nhập thông tin cơ bản để bắt đầu — hình ảnh, biến thể và các mục còn lại sẽ điền ở màn hình tiếp theo.',
        'name' => 'Tên sản phẩm',
        'type' => 'Loại sản phẩm',
        'sku' => 'Mã SKU',
        'price' => 'Giá bán',
        'price_hint' => 'Không bắt buộc — có thể để trống và nhập sau trong trang chỉnh sửa.',
        'status' => 'Đăng bán ngay',
        'status_hint' => 'Tắt để lưu ở dạng nháp, chưa hiển thị ngoài cửa hàng.',
        'submit' => 'Tạo & chỉnh sửa',
    ],
