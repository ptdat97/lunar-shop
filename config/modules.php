...
return [
    ...
    */
    ...
    'paths' => [
        ...
        |
        */
        // Lowercase `modules/` — this project predates nwidart adoption and the
        // directory has always been lowercase. On a case-insensitive filesystem
        // base_path('Modules') resolves anyway, but breaks on Linux/CI.
