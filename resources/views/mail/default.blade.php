{{-- Mail theme. Must live at resources/views/mail/default.blade.php, NOT at
     vendor/mail/html/themes/default.css: Illuminate\Mail\Markdown::render()
     prefers the view "mail.default" and only that path is compiled as Blade,
     which is what lets the store's accent colour below be dynamic. --}}
/* Base */
...
/* Store logos are usually wordmarks, not Laravel's square mark: let width
   follow the aspect ratio and cap it rather than forcing a 75px square. */
.logo {
    height: auto;
    margin-top: 15px;
    margin-bottom: 10px;
...
.button-primary {
    ...
    border-right: 18px solid {{ $accent }};
