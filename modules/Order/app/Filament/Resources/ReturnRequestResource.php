...
class ReturnRequestResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                TextColumn::make('reference')->label(__('admin.returns.reference'))->searchable(),
                TextColumn::make('order.reference')->label(__('admin.returns.order'))->searchable(),
                ...
                TextColumn::make('reason')->label(__('admin.returns.reason'))->limit(30),
                TextColumn::make('lines_count')->counts('lines')->label(__('admin.returns.items')),
                TextColumn::make('created_at')->label(__('admin.returns.requested_at'))->dateTime('d/m/Y H:i'),
            ])
            ->filters([
            ...
            ->recordActions([
                Action::make('approve')
                    ...
                    ->schema([
                        Toggle::make('refund')->label(__('admin.returns.also_refund'))->default(true),
                        Textarea::make('staff_note')->label(__('admin.returns.staff_note')),
                    ])
